...
//**
//** function Append2File, Parameter list: $file,$text=array()
//**
//** Appends $text to file.
//** 
//**

function Append2File($file,$text=array())
{
    ...
    {
        die("Error appending to file: $file");
    }
...
;
    ...
    $this->TransferHashKeys($hash,$rhash);
